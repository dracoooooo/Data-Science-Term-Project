...
public class Map {
    ...
    public Result move() {
        print();
        if(d1.getHealthPoint()==0) return Result.Y_WIN;
        else if(d2.getHealthPoint()==0) return Result.X_WIN;
    ...
    public void print() {
        ...
        System.out.println(d1.getSymbol().toUpperCase()+" : "+d1.getHealthPoint());
        System.out.println(d2.getSymbol().toUpperCase()+" : "+d2.getHealthPoint());
    }
